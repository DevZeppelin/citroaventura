...
const SectionBackgroundFixed3 = () => {
    return (
        <section>
        <div className="p-2 md:p-32 py-4 md:py-32 font-bold text-center bg-cover bg-inside-m md:bg-inside bg-right bg-fixed flex md:grid md:grid-cols-2 h-screen">
         
           
           <Fade left>
           
              <div className="text-white space-y-3 xs:text-sm sm:text-base md:text-xl font-bold mt-96">
